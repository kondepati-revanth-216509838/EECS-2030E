...
public final class Complex {
	...
	public Complex add(Complex c) {
		double newRe = c.real + this.real;
		double newIm = c.im + this.im;
	...
	public Complex multiply(Complex c) {
		...
		double im = (this.im * c.real) + (this.real * c.im);
	...
	public int hashCode() {
		...
		double hashReal = 9999 * this.real;
		
		double hashIm = 99 * this.im;
		
		double sum = hashReal + hashIm;
	...
	public boolean equals(Object obj) {
		...
		final Complex piece = (Complex) obj;
		
		if (piece.re() == this.real && piece.im() == this.im) {
			return true;
		}
	...
	public String toString() {
		...
		return this.real + sign + Math.abs(this.im) + "i";
	}
